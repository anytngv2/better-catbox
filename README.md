...
[![GitHub Release](https://img.shields.io/github/v/release/AnytngV2/better-catbox?logo=github)](https://github.com/anytngv2/better-catbox/releases/latest)
[![GitHub Last Commit](https://img.shields.io/github/last-commit/AnytngV2/better-catbox?logo=github)](https://github.com/anytngv2/better-catbox/commits/main)
![GitHub file size in bytes](https://img.shields.io/github/size/AnytngV2/better-catbox/script.js)

<!-- [![Greasy Fork Version](https://img.shields.io/greasyfork/v/565142?logo=greasyfork&color=%23670000)]() -->

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/logo_dark.png">
  <source media="(prefers-color-scheme: light)" srcset="assets/logo_light.png">
  <img alt="Fallback image description" src="assets/logo_dark.png">
</picture>
...
<div align="center">
<img alt="" src="preview/home_before.png" width="49%">
<img alt="" src="preview/home_after.png" width="49%">
</div>
